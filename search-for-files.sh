...
fragment=`zenity --entry --title="$window_title - Name contains:" --window-icon="$window_icon" --text="Matthijs is cool. Search strings less than 2 characters are ignored"`
